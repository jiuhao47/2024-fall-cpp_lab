...
int main() {
  ...
  /*
      创建全局变量:
      @res = dso_local global [5 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4],
     align 16
  ...
  */
  ...
  auto res_init_val_array = llvm::ConstantArray::get(
      llvm::ArrayType::get(llvm::Type::getInt32Ty(context), 5), res_arrayref);
  // 创建全局变量res
  ...
  // 创建全局变量idx
  auto idx =
      new GlobalVariable(*module, builder.getInt32Ty(), false,
                         GlobalValue::LinkageTypes::ExternalLinkage,
                         ConstantInt::get(builder.getInt32Ty(), 0), "idx");
  ...
  */
  auto sub_function = Function::Create(
      FunctionType::get(Type::getInt32Ty(context),
                        ...
                        false),
      GlobalValue::LinkageTypes::ExternalLinkage, "sub", *module);
  ...
  */
  ...
  auto sub_if_false =
      llvm::BasicBlock::Create(context, "if_false", sub_function);
  ...
  */
  auto main_function = Function::Create(
      ...
      GlobalValue::LinkageTypes::ExternalLinkage, "main", *module);
  auto main_entry = BasicBlock::Create(context, "entry", main_function);
  // 设置插入点
  builder.SetInsertPoint(main_entry);
  // 调用sub函数
  auto sub_call1 = builder.CreateCall(
      sub_function, {builder.getInt32(2), builder.getInt32(5)});
  // 加载idx并在加载后加1
  ...
  auto res_gep =
      builder.CreateGEP(Type::getInt32Ty(context), (Value *)res, idx_load);
  // 存储返回值到res[idx]
