                                ...
                                int node_pos, std::string name )
{
  ...
  llvm::BasicBlock *obc_check =
      llvm::BasicBlock::Create( context, "obc_check_", function );
  llvm::BasicBlock *obc_err = llvm::BasicBlock::Create( context, "obc_err_", function );
  llvm::BasicBlock *obc_ok  = llvm::BasicBlock::Create( context, "obc_ok_", function );
