...
std::string RelOp_map[] = {"EQUAL",      "NON_EQUAL", "LESS",
...
class AstSerializer : public AstNode_Visitor {
   public:
    ...
    void serialize(ast_node& node) { node.accept(*this); }

    virtual void visit(comp_unit_node& node) override {
        writer.StartObject();
        writer.Key("type");
        writer.String("comp_unit_node");
        writer.Key("line");
    ...
    virtual void visit(comp_unit_child_node& node) override {
        writer.StartObject();
        writer.Key("type");
        writer.String("comp_unit_child_node");
        writer.Key("line");
        writer.Int(node.line);
        writer.Key("pos");
        writer.Int(node.pos);
    ...
    virtual void visit(var_def_stmt_node& node) override {
        ...
        writer.Key("pos");
        writer.Int(node.pos);
        writer.Key("var_def_nodes");
        writer.StartArray();
        for (auto var_def_node : node.var_defs) {
            var_def_node->accept(*this);
        }
        writer.EndArray();
        writer.EndObject();
    }

    virtual void visit(var_def_node& node) override {
        writer.StartObject();
        writer.Key("type");
        writer.String("var_def_node");
        writer.Key("line");
        writer.Int(node.line);
        writer.Key("pos");
        writer.Int(node.pos);
