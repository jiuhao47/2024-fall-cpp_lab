...
class AstBuilder : public SafeCParserBaseVisitor {
   public:
    ...
    virtual antlrcpp::Any visitObcArray(
        SafeCParser::ObcArrayContext* ctx) override;
    virtual antlrcpp::Any visitUnobcArray(
        SafeCParser::UnobcArrayContext* ctx) override;
    virtual antlrcpp::Any visitBlock(SafeCParser::BlockContext* ctx) override;
    virtual antlrcpp::Any visitBlockItem(
        SafeCParser::BlockItemContext* ctx) override;
